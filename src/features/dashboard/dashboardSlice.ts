...
const dashboardSlice = createSlice({
  ...
  reducers: {
    ...
    setHighestStudentList(state, action: PayloadAction<Student[]>) {
      Object.assign(state.highestStudentList, action.payload);
    },
    setLowestStudentList(state, action: PayloadAction<Student[]>) {
      Object.assign(state.lowestStudentList, action.payload);
    },
    setRankingByCityList(state, action: PayloadAction<RankingByCity[]>) {
      Object.assign(state.rankingByCityList, action.payload);
    },
  },
});
